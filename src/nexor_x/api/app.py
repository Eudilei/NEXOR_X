...
def create_app(kernel: Any) -> FastAPI:
    ...
    async def paper_open(symbol: str) -> dict[str, Any]:
        try:
    ...
    async def paper_close(position_id: int, body: PaperCloseRequest) -> dict[str, Any]:
        try:
