...
def create_app(kernel: Any) -> FastAPI:
    ...
    async def discover_edges() -> dict[str, Any]:
    ...
    async def manage_position(position_id: int, body: PositionManageRequest) -> dict[str, Any]:
        try:
    ...
    async def manage_all_positions() -> dict[str, Any]:
        try:
